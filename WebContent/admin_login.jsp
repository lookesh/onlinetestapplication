...
<table>
<tr><td>Username:<s:textfield name="user.username" id="username" /></td></tr>
<tr><td><div id="error"></div></td></tr>
<tr><td>Password:<s:password name="user.password" id="password"/></td></tr>
<tr><td><div id="error2"></div></td></tr>
<tr><td><s:submit value="login" id="login"/></td></tr>
</table>
</s:form>
